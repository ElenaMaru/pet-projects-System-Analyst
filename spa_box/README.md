...
Файл: [`BRD (Business Requirements Document).docx`]([file/BRD (Business Requirements Document).docx](https://github.com/ElenaMaru/pet-projects-System-Analyst/blob/main/spa_box/file/BRD%20(Business%20Requirements%20Document).docx))
